...
document.addEventListener(
   ...
   function () {
      ...
      trackEvent("results_page", { action: "view" });
      ...
      if (reviewLink) {
         reviewLink.addEventListener("click", function () {
            trackEvent("resume_review_click", { source_page: "result_page" });
         });
      }
...
function handleFeedbackBox() {
   for (var star of ["#5_star, #4_star"]) {
      $(star).click(function () {
         trackEvent("result_page_feedback_high_stars", { action: "click" });
         window.location.href = "/html/review_us.html";
      });
   }
   for (var star of ["#3_star, #2_star, #1_star"]) {
      $(star).click(function () {
         trackEvent("result_page_feedback_low_stars", { action: "click" });
         window.location.href = "/html/feedback_us.html";
      });
   }

   $("#not_now").click(function () {
      trackEvent("result_page_feedback_not_now", { action: "click" });
...
function activateFeedback() {
   ...
   trackEvent("result_page_feedback", { action: "view" });
}
      ...
      if (
         ...
         document
            ...
            .addEventListener("click", function () {
               trackEvent("job_recommendation", { action: "click" });
         ...
         trackEvent("job_recommendation", { action: "display" });
      }
